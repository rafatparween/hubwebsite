...
export default function PrinterSetupSection() {
  return (
    <section className="mb-16 sm:mb-20 lg:mb-32 py-12 sm:py-16 lg:py-20 min-h-[750px] mt-[-40px] sm:mt-[-50px] lg:mt-[-69px]">
      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-4">
        <div className="bg-gradient-to-br from-[#59c7b5]/10 via-[#0095d4]/10 to-[#59c7b5]/5 rounded-4xl p-6 sm:p-8 lg:p-12 shadow-2xl border border-[#59c7b5]/20 backdrop-blur-sm">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-16">
            ...
            <div className="flex-1 w-full">
              <div className="mb-6 sm:mb-8">
                ...
                <h3 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-800 mb-4 leading-snug">
                  Contact Support –{" "}
                  <span className="text-[#0095d4]">Chat Live</span>
                  <span className="text-xl sm:text-2xl lg:text-3xl font-bold ml-2 sm:ml-4 bg-gradient-to-r from-[#59c7b5] to-[#0095d4] bg-clip-text text-transparent">
                    {" "}or Call Us
                  </span>
                </h3>
              ...
              <div className="space-y-3 sm:space-y-4 mb-8 sm:mb-12">
                ...
                {[
                  ...
                  "Flashing blue light on the wireless printer",
                  "Error printing from wireless printer",
                  "Error setting up the wireless printer",
                ].map((issue, index) => (
                  <div
                    key={index}
                    className="flex items-start sm:items-center space-x-4 p-3 sm:p-4 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:border-[#59c7b5]/30 transition-all duration-300 group"
                  >
                    <div className={`w-2 h-2 ${index % 2 === 0 ? "bg-[#59c7b5]" : "bg-[#0095d4]"} rounded-full animate-pulse mt-2 sm:mt-0`} />
                    <span className="text-base sm:text-lg font-medium text-gray-800 group-hover:text-gray-900 leading-snug">
                      {issue}
                    </span>
                  </div>
                ))}
                ...
                <div className="text-center mt-6 pt-4 border-t border-gray-200">
                  <p className="text-lg sm:text-xl lg:text-[24px] font-bold bg-gradient-to-r from-[#59c7b5] to-[#0095d4] bg-clip-text text-transparent">
                    {/* Call Us For Printer Support:- +1 (844) 491-5152 */}
                  </p>
                </div>
              </div>
